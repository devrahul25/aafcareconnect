...
const DEMO_COURSES = [
  { id: 1,  title: "Safeguarding Children: Level 2",       category: "Safeguarding",          level: "Foundation",   duration: 60,  learners: 84, completions: 71, rating: 4.9, mandatory: true,  status: "published", image: "https://media.base44.com/images/public/6a3a6f4029c809f694c625de/7542d57a4_generated_image.png" },
  { id: 2,  title: "Therapeutic Parenting in Practice",    category: "Therapeutic Parenting", level: "Intermediate", duration: 90,  learners: 61, completions: 44, rating: 4.8, mandatory: false, status: "published", image: "https://media.base44.com/images/public/6a3a6f4029c809f694c625de/ef9f132b5_generated_image.png" },
  { id: 3,  title: "Attachment Theory for Foster Carers",  category: "Attachment",            level: "Intermediate", duration: 75,  learners: 72, completions: 58, rating: 4.7, mandatory: true,  status: "published", image: "https://media.base44.com/images/public/6a3a6f4029c809f694c625de/8e231cade_generated_image.png" },
  { id: 4,  title: "First Aid & Emergency Response",       category: "Health & Safety",       level: "Foundation",   duration: 120, learners: 53, completions: 43, rating: 4.9, mandatory: true,  status: "published", image: "https://media.base44.com/images/public/6a3a6f4029c809f694c625de/1a3301f4b_generated_image.png" },
  { id: 5,  title: "Understanding Trauma & Loss",          category: "Therapeutic Parenting", level: "Advanced",     duration: 60,  learners: 38, completions: 30, rating: 4.6, mandatory: false, status: "published", image: "https://media.base44.com/images/public/6a3a6f4029c809f694c625de/800395924_generated_image.png" },
  { id: 6,  title: "Cultural Identity & Diversity",        category: "Equality & Diversity",  level: "Foundation",   duration: 45,  learners: 47, completions: 35, rating: 4.5, mandatory: false, status: "published", image: "https://media.base44.com/images/public/6a3a6f4029c809f694c625de/39df554ee_generated_image.png" },
  { id: 7,  title: "Fostering Legislation Update 2024",    category: "Legislation",           level: "Foundation",   duration: 30,  learners: 91, completions: 84, rating: 4.4, mandatory: true,  status: "published", image: "https://media.base44.com/images/public/6a3a6f4029c809f694c625de/54b8eafd2_generated_image.png" },
  { id: 8,  title: "Safe Caring in the Home",              category: "Safeguarding",          level: "Foundation",   duration: 50,  learners: 0,  completions: 0,  rating: null, mandatory: true,  status: "draft",     image: "https://media.base44.com/images/public/6a3a6f4029c809f694c625de/844c5cce0_generated_image.png" },
];
const DEMO_LEARNERS = [
