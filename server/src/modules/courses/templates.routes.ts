...
router.put('/:id', validate(validator.updateCourseSchema), controller.updateTemplate);
...
router.put('/:courseId/sections/:sectionId', validate(validator.updateSectionSchema), controller.updateSection);
...
router.put('/:courseId/sections/:sectionId/videos/:videoId', validate(validator.updateVideoSchema), controller.updateVideo);
...
router.put('/:courseId/sections/:sectionId/documents/:documentId', validate(validator.updateDocumentSchema), controller.updateDocument);
...
router.put('/:courseId/sections/:sectionId/rich-text/:richTextId', validate(validator.updateRichTextSchema), controller.updateRichText);
...
router.put('/:courseId/sections/:sectionId/quizzes/:quizId', validate(validator.updateQuizSchema), controller.updateQuiz);
...
router.put('/quizzes/:quizId/questions/:questionId', validate(validator.updateQuizQuestionSchema), controller.updateQuizQuestion);
...
router.put('/quizzes/:quizId/questions/:questionId/answers/:answerId', validate(validator.updateQuizAnswerSchema), controller.updateQuizAnswer);
